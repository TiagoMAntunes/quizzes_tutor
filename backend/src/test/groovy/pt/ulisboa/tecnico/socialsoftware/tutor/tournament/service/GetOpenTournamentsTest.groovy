...
class GetOpenTournamentsTest extends Specification {
    ...
    def setup() {
        ...
        tournamentDto1.setStartTime(TOMORROW)
        tournamentDto1.setFinishTime(LATER)
        ...
        diffTournamentDto.setStartTime(TOMORROW)
        diffTournamentDto.setFinishTime(LATER)
        ...
        tournamentDto2.setStartTime(TOMORROW)
        tournamentDto2.setFinishTime(LATER)
        ...
        tournamentDto3.setStartTime(TOMORROW)
        tournamentDto3.setFinishTime(LATER)
    ...
    def "no open tournaments"(){
        ...
        result.setFinishTime(YESTERDAY)
